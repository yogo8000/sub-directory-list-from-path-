...
def create_list_from_directory_path(directory_path):
    ...
    all sub directories using the os.walk method with list comprehension.
    The function returns a list of all sub directories(full paths).
    :param directory_path: The path of the directory.
    :return: List of all sub directories of a directory path given as input.
    """
